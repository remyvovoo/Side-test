...
- **⚠️ Provenance de la plaque d'essai** : `public/studio-plates/noir-acrylique.jpg` est tirée d'une **photo de marchand** (référence fournie par Remy, filigrane effacé, scène vidée par retouche). Bonne pour juger l'approche **en local uniquement — interdite en production** (droits). Avant tout déploiement de l'univers « Studio Photo » : la remplacer par une photo à nous (Remy photographie ses propres supports/scènes vides, ou banque d'images licenciée). Piste suivante notée : avec une photo de support acrylique **vide sur fond noir**, les montants avant du support s'extraient facilement (matte de luminance) en calque d'avant-plan → la carte se glisserait DERRIÈRE eux, occlusion réelle très vendeuse.
